...
public:
	...
	Polynomial(bigint* elem, bigint * xpoints, int elem_size, int xpoints_size, bigint pubmoduli, int pubmoduli_size, unordered_map <string, int> map, bool psu);
	bigint* evaluate (bigint *, bigint * , int, int, bigint);
	bigint* evaluate_psu (bigint *, bigint * , int, int, bigint);
